...
#imagens
image_path = os.path.join(os.path.dirname(__file__), 'assets', 'Tela_inicial.png')
image_path2 = os.path.join(os.path.dirname(__file__), 'assets', 'Background.png')

bg_inicial = pygame.image.load(image_path).convert()
bg_game = pygame.image.load(image_path2).convert()
...
def resetGame():
    ...
    global size_snake, pixels, x, y, velocidade_x, velocidade_y
    size_snake = 1
    pixels = []
    x = largura / 2
    y = altura / 2
